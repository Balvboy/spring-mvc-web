...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${cxt}/resource/css/bootstrap.css">
    
    <link rel="stylesheet" type="text/css" href="${cxt}/resource/css/theme.css">
    <link rel="stylesheet" href="${cxt}/resource/font-awesome/css/font-awesome.css">

    <script src="${cxt}/resource/js/jquery-1.7.2.min.js" type="text/javascript"></script>
